...
const blogPosts = [
	{
		...
		description:
			'Learn how to take your e-commerce photos from good to great with these simple tips.',
	...
	},
	{
		...
		description:
			'Discover how artificial intelligence can level the playing field for UMKM and small enterprises.',
		image: 'https://placehold.co/600x400.png',
	...
	},
	{
		...
		description:
			'We are excited to launch our new AI background generator. Here is how it works.',
		image: 'https://placehold.co/600x400.png',
	...
	},
	{
		...
		description:
			'Color psychology is key. Learn how to pick colors that resonate with your target audience.',
		image: 'https://placehold.co/600x400.png',
		hint: 'color palette',
		slug: 'brand-colors',
	},
	{
		...
		description:
			'A step-by-step guide to resizing and formatting your images for major e-commerce platforms.',
		image: 'https://placehold.co/600x400.png',
	...
	},
	{
		...
		description:
			'Master lighting to create professional-looking product shots with any camera.',
		image: 'https://placehold.co/600x400.png',
		hint: 'photo lighting',
